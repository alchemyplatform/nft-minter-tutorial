...
3. Create a `.env` file in the root directory this `nft-minter` by entering the following on your command line: `vim .env` and then your [Alchemy API Key](https://docs.alchemyapi.io/alchemy/tutorials/nft-minter#create-your-alchemy-api-key), [Pinata Key and Pinata Secret](https://pinata.cloud/keys). Altogether, your `.env` file should look like so:
